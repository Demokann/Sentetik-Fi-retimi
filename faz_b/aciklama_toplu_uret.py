...
Kullanım:
    python -m faz_b.aciklama_toplu_uret --burst-size 200 --cooldown-min 15 --workers 3
...
import faz_b.aciklama_uretim_core as core
from faz_b.aciklama_uretim_core import (
...
def main():
    ...
    if kalan_toplam == 0:
        print("Tüm batch'ler tamamlandı! Sonraki adım: python -m faz_b.aciklama_birlestir")
    else:
...
def _md_yaz(md_yolu: Path, faturalar: list[dict], cikti: dict, model: str) -> None:
    from faz_b.aciklama_uretim_core import kalemler_ozetle
