...
yedek alıp yazar.
    ...
    python -m faz_b.aciklama_ek_duzelt --cikti-dizini data/ciktilar_25k-4
    python -m faz_b.aciklama_ek_duzelt --cikti-dizini data/ciktilar_25k-4 --uygula
"""
...
from faz_b.aciklama_uretim_core import _iyelik_sonu_mu, _KALIN_SESLI, _SESLI
