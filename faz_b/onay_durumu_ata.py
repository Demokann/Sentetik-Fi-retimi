...
Kullanim:
    python -m faz_b.onay_durumu_ata                       # varsayilan yollar
    python -m faz_b.onay_durumu_ata --tum-kayitlar        # açiklamasizlari da yaz (onay_durumu "")
    python -m faz_b.onay_durumu_ata --cikti-dizini data/aciklama \
...
from ortak.cift_grup import cift_grup_id, ciftleri_bul
from faz_b.iliskisel_es_etiketle import ILISKISEL_TURLER, esleri_etiketle
