...
Kullanım:
    python -m faz_b.batch_analiz --cikti-dizini data/aciklama_25k
    python -m faz_b.batch_analiz --cikti-dizini data/aciklama_25k --batch 1-10
    python -m faz_b.batch_analiz --cikti-dizini data/aciklama_25k --etiket-json ""  # havuzsuz, hızlı
"""
...
from faz_b.batch_hazirla import (
