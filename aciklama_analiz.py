...
Kullanım:
    # pilot jsonl
    python aciklama_analiz.py --girdi deneme.jsonl
    # runner batch çıktıları (glob)
    python aciklama_analiz.py --cikti-dizini data/aciklama
    # tek/çoklu dosya
    python aciklama_analiz.py --girdi data/aciklama/batch_0001_ciktilar.json
"""
...
from aciklama_uretim_core import KATEGORILER, distinct_n, _dedup_normalize
