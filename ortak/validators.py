...
from ortak.politika import kalem_limiti
from faz_a.generators.anomaly_injector import ANOMALI_FONKSIYONLARI
from faz_a.generators.field_generator import FIYAT_ARALIGI_GENEL, ANOMALI_URUN_MAKULLUGU
