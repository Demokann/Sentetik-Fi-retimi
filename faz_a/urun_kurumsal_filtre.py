...
Kullanim:
    python -m faz_a.urun_kurumsal_filtre              # RAPOR (dosyaya dokunmaz)
    python -m faz_a.urun_kurumsal_filtre --uygula     # yedek alip yazar
    python -m faz_a.urun_kurumsal_filtre --ornek 15   # elenen/kalan ornek sayisi
...
CSV_YOLU = Path(__file__).parent.parent / "data" / "urun_verileri" / "temiz_urunler.csv"
...
def main() -> None:
    ...
    print("[!] REGENERATE gerekir: python -m faz_a.main --count 100000 --anomali-orani 0.25 ...")
