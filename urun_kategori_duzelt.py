...
Kullanım:
    python urun_kategori_duzelt.py                # SADECE rapor (dosyaya dokunmaz)
    python urun_kategori_duzelt.py --uygula       # yedek alıp CSV'yi günceller
"""
...
def main():
    ...
    for k, v in sayac.most_common():
        print(f"      {k}: {v}")
    print("\n[!] SIRADAKİ: 'python main.py --count 100000 --anomali-orani 0.25 "
